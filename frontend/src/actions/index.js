import { getUrlServerText } from './../services/getUrlServerText'

export const SET_TEXT_DISPLAY = 'SET_TEXT_DISPLAY'
export const GET_TEXT_DISPLAY_PENDING = 'GET_TEXT_DISPLAY_PENDING'

const setTextDisplayPending = payload => ({type: GET_TEXT_DISPLAY_PENDING, payload})
...
export const getTextFromServer = payload =>{
  return (dispatch, getState) =>{
      ...
      return fetch(getUrlServerText(payload)).then(dataResponse=>{
